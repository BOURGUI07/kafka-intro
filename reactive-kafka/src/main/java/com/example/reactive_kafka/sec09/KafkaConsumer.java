package com.example.reactive_kafka.sec09;
...
public class KafkaConsumer {
    ...
    public static void main(String[] args) {
        ...
        /*
            With concatMap(), the consumer drains each flux one by one.
            It doesn't go to the other flux until it finishes off draining the flux that's before him
         */
    }
